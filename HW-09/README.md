# Домашнее задание к занятию "Кеширование Redis/memcached" - `Жихарева Полина`
...
3. Смягчение всплесков трафика.
4. Оптимизация дорогих вычислений.
5. Балансировка нагрузки между сервисами. 
6. Локальность данных и работа при частичных сбоях. 
